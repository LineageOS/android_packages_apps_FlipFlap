...
public class RectangularView extends FlipFlapView {
    ...
    public RectangularView(Context context) {
        ...
        RelativeLayout ignoreCallButton = (RelativeLayout) findViewById(R.id.ignore_button);
        ignoreCallButton.setOnClickListener(view -> endCall());

        ImageButton alarmSnoozeButton = (ImageButton) findViewById(R.id.snooze_button);
        alarmSnoozeButton.setOnClickListener(view -> snoozeAlarm());
        ImageButton alarmDismissButton = (ImageButton) findViewById(R.id.dismiss_button);
