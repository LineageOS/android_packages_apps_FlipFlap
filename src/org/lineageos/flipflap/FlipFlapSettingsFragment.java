...
public class FlipFlapSettingsFragment extends PreferenceFragment
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mTextView.setText(getString(isEventReceiverEnabled() ?
        ...
        mSwitchBar.setActivated(isEventReceiverEnabled());
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        Preference touchSensitivity = (SwitchPreference) findPreference(KEY_TOUCH_SENSITIVITY);
        ...
        if (!FlipFlapUtils.getHighTouchSensitivitySupported()) {
            behaviourCategory.removePreference(touchSensitivity);
        }
    }
